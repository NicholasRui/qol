...
def pgstar_Grid1_enable(self, num_cols, num_rows, reset=False,
    ...
    """
    self.add_to_pgstar(category='Grid1',
    ...
    self.add_to_pgstar(category='Grid1', comment='<= 10',
    ...
    if reset:
        ...
        self.add_to_pgstar(category='Grid1', comment='number from 1 at top',
                control='Grid1_plot_row(:)', value=1)
        self.add_to_pgstar(category='Grid1', comment='plot spans this number of rows',
                control='Grid1_plot_rowspan(:)', value=1)
        self.add_to_pgstar(category='Grid1', comment='number from 1 at left',
                control='Grid1_plot_col(:)', value=1)
        self.add_to_pgstar(category='Grid1', comment='plot spans this number of columns',
...
def pgstar_Grid1_add_plot(self, plot_col, plot_row, plot_name,
    ...
    self.add_to_pgstar(category=category,
...
def pgstar_Grid1_qol_default(self, write_path):
    ...
    self.add_to_pgstar(category=category, comment='reset to default',
